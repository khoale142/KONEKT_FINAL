export const ROUTES = {
  ...
  STORE_PRODUCTS_NEW: '/store/catalog?create=product',
  STORE_INGREDIENTS: '/store/catalog',
  STORE_INGREDIENTS_NEW: '/store/catalog?create=ingredient',
  STORE_RECIPES: '/store/catalog',
  STORE_RECIPES_NEW: '/store/catalog?create=product',
